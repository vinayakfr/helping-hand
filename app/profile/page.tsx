  ...
  return (
    <div>
      ...
      <div className="flex lg:gap-3 place-content-center place-items-end px-5 lg:px-10 pt-24 lg:pt-10 absolute">
        ...
        />
        <h1 className="text-2xl lg:text-5xl font-bold text-white">Vinayak Srivastava</h1>
      </div>
      <div className="pt-[13rem] lg:pt-[22.5rem]">
        ...
        <div className="py-10 px-5">
          <h1 className="font-bold text-3xl lg:text-5xl ">Personal Information:</h1>
          <div className="grid grid-cols-2 grid-rows-5 place-content-center place-items-center gap-3 lg:gap-5 pt-5">
            ...
            <div className="flex flex-col place-content-center place-items-start w-[7rem] h-[7.5rem] lg:w-[17.5rem] lg:h-[5rem]">
              ...
              <p className="font-medium lg:text-lg">A-8, Mother Apartment, Plot-6, Sector-5, Dwarka, New Delhi</p>
            </div>
            <div className="flex flex-col place-content-center place-items-start w-[7rem] h-[7.5rem] lg:w-[17.5rem] lg:h-[5rem]">
