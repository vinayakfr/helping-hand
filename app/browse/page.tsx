  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 place-content-center place-items-center">
        <h1 className="text-center font-black lg:text-9xl">
        ...
        <input
          type="text"
          className="border-2 border-black bg-white rounded-r-full rounded-l-full lg:w-[50rem] h-16"
        />
        <button className="bg-black hover:bg-white text-white hover:text-black border-4 border-black hover:font-bold rounded-r-full rounded-l-full text-2xl p-4 shadow-xl hover:shadow-2xl">
          Search
        </button>
      </div>
      <div className="bg-zinc-200 my-10 flex flex-col place-content-center place-items-center rounded-xl mx-10">
