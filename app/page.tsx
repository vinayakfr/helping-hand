  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-5 place-content-center place-items-center py-5">
        <button className="h-16 w-40 rounded-xl bg-black text-white"><a href="" className="text-center xl:text-2xl font-thin">Read More</a></button>
        <button className="h-16 w-40 rounded-xl bg-black text-white font-thin"><a href="" className="text-center xl:text-2xl">Join Us</a></button>
      </div>
      <p className="text-center xl:text-xl">Already a member? {" "}<a href="" className="underline">Log in</a></p>
    </div>
  );
}
